...
: ${AMENT_CURRENT_PREFIX:="/home/user/workspace/ros2_moveit2/src/wholebody_description/install/wholebody_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wholebody_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wholebody_description/environment/path.sh"
